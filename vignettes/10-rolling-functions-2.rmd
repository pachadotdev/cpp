...
vignette: >
  %\VignetteIndexEntry{Rolling Functions with Missing Values}
...
```cpp
[[cpp4r::register]] doubles cumsum2_cpp_(doubles x, bool na_rm = false) {
  int n = x.size();
...
```cpp
[[cpp4r::register]] doubles cumprod2_cpp_(doubles x, bool na_rm = false) {
  int n = x.size();
...
```cpp
[[cpp4r::register]] doubles cummin2_cpp_(doubles x, bool na_rm = false) {
  int n = x.size();
...
```cpp
[[cpp4r::register]] doubles cummax2_cpp_(doubles x, bool na_rm = false) {
  int n = x.size();
