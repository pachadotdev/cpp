...
A previous version of cpp4r used a global protection list stored in an R global option, but this caused [multiple issues](https://github.com/pachadotdev/cpp4r/issues/330).
