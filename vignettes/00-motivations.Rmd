...
[cpp4rtest/src/sum.cpp](https://github.com/r-lib/cpp4r/blob/main/cpp4rtest/src/sum.cpp) contains the code ran in these benchmarks.
...
git clone https://github.com/r-lib/cpp4r
cd cpp4r
