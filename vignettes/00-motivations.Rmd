...
[Rcpp](https://cran.r-project.org/package=Rcpp) was first published to CRAN in 2008, and [Rcpp4r](https://cran.r-project.org/package=Rcpp4r) in 2014.
...
Here are some real examples of the reduction in compile time and peak memory usage after converting packages to cpp4r.
...
| package | Rcpp compile time | cpp4r compile time | Rcpp peak memory | cpp4r peak memory | Rcpp commit | cpp4r commit |
|-----------|-----------|-----------|-----------|-----------|-----------|-----------|
...
ggplot(b_release, aes(x = len, y = min / len, color = pkg)) +
  ...
  labs(
    tite = "cpp4r uses constant time protection",
