...
vignette: >
  %\VignetteIndexEntry{Motivations for cpp4r}
...
should_run_benchmarks <- function(x) {
  get("requireNamespace")("cpp4rtest", quietly = TRUE) && asNamespace("cpp4rtest")$should_run_benchmarks()
}
```
...
[cpp4rtest/src/sum.cpp](https://github.com/pachadotdev/cpp4r/blob/main/cpp4rtest/src/sum.cpp) contains the code ran in these benchmarks.
