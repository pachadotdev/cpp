...
In contrast the headers in cpp4r contain only 1,734 lines of code in 19 files.
...
ggplot(b_release, aes(x = len, y = min / len, color = pkg)) +
  ...
  labs(
    title = "cpp4r uses constant time protection",
...
cpp4r is a alternative implementation of C++ bindings to R that chooses different design trade-offs and features.
