...
If the code is already written and you don't have a very compelling need to use cpp4r I would recommend you continue to use Rcpp.
However if you *do* feel like your project will benefit from using cpp4r this vignette will provide some guidance and doing the conversion.
