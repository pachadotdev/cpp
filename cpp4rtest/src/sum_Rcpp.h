...
[[cpp4r::register]] SEXP Rcpp_sum_dbl_for_(SEXP x_sxp) {
...
[[cpp4r::register]] SEXP Rcpp_sum_int_for_(SEXP x_sxp) {
...
[[cpp4r::register]] SEXP Rcpp_sum_dbl_foreach_(SEXP x_sxp) {
  Rcpp::NumericVector x(x_sxp);
  double sum = 0.;
...
[[cpp4r::register]] SEXP Rcpp_sum_dbl_accumulate_(SEXP x_sxp) {
  Rcpp::NumericVector x(x_sxp);
  return Rf_ScalarReal(std::accumulate(x.cbegin(), x.cend(), 0.));
}

[[cpp4r::register]] SEXP Rcpp_grow_(SEXP n_sxp) {
...
[[cpp4r::register]] SEXP Rcpp_push_and_truncate_(SEXP size_sxp) {
